<x-app-layout>
  ...
  <h2 class="text-gray-900 text-lg font-medium title-font mb-5">Edit Details</h2>
      ...
      @csrf    
        ...
        <label class="leading-7 text-sm text-gray-600">Troject Title</label>
        <input type="text" id="title" name="title" value="{{$task->title}}" class="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
       
      </div> <span style="color:red;">    @error('title')
        {{$message}}
        @enderror </span><br><br>
      <div class="relative mb-4">
        <label  class="leading-7 text-sm text-gray-600">Task Detail</label>
      ...
      <div class="relative mb-4">
        ...
        @enderror </span><br><br>
         ...
         Preview: <img src="{{asset('storage/images/'.$project->image)}}" width="250px"/>
