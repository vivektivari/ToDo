                        ...
                        <div class="container px-5 py-24 mx-auto">
                            <div class="lg:w-4/5 mx-auto flex flex-wrap">
                                <img alt="ecommerce"
                                    ...
                                    src="{{ asset('storage/images/' . $project->image) }}" width="400px">
                                <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                                    ...
                                    <p class="leading-relaxed">Project Detail: "{{ $project['detail'] }}"</p>
                            ...
                            <br><br>
                            <p>Task List Of This Project:</p><br>
                            @if (session('status'))
                                {{ session('status') }}
                            @endif
                            <br>
                            <a href="{{ route('tasks.create', ['project_id' => $project->id]) }}"> <button
